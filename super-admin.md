...
- Create and manage **clubs** and assign Club Admins to them
- Create and manage **leagues** and assign League Admins to them
- Create **seasons** and set the active current season
- Create **official (referee) profiles**
- Manage all **user roles** — grant or remove any role from any user
- Create and manage **venues** (with full control including deletion)
- Deactivate clubs or leagues when needed
...
3. Optionally tap the logo area to **upload a club logo**.
4. Tap **Save**.
...
- Full profile (name, email, phone, county, certification)
- Upcoming match assignments
- Availability status
