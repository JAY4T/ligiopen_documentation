...
- Position
- Jersey number
- **Status badge** — `Active` (has a LigiOpen account) or `Shadow` (profile exists, but player hasn't claimed it yet)
...
**Viewing teams:**
Tap the **Teams section** in the Club tab. You'll see a list of all your teams.
