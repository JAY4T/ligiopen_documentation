...
- Check your assigned fixtures before match day
- Kick off the match in the app when the referee blows the whistle
- Record every goal, card, and substitution as it happens
- Keep the match clock updated so fans see the correct minute
- Submit the final result at full time
...
- Date and time
- Venue
- Current status (Scheduled, In Progress, etc.)
...
- Changes the match status from **Scheduled** to **In Progress**
- Starts the **live match clock**
- Makes the match appear as "LIVE" for all fans browsing LigiOpen
